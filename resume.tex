...
\cvevent{Business Plan for {IMPACT} System}{Data Analyst; Work from Home}{Sep 2020}{Online}
...
\begin{itemize}
    \item Textual analysis tasks: \ding{172} Analyse the readability \& sentiment of the firm-specific information disclosed by companies through investor in-house meeting reports; 
...
% \hspace{4.2mm} \textit{\small The grant is associated with the research project: Oxford-SRUK Ontology Alignment.}
...
% \hspace{4.2mm} \textit{\small The prize is associated with the top 1 ranking in the class of my undergraduate's degree.}
